...
## 5. 4 ポリシー実機比較 (本環境, 同一データセット 640×360)
...
|---|---|---|---|---|---|
| **SmolVLA** | batch8, 4.2 step/s | 20K ≈ 80 分 | 0.034 | **対応・良好** | **RTC で滑らか。4 ポリシー中の推奨** |
...
| VLA-JEPA | batch4, 0.53 step/s | 30K ≈ 15.8h | 0.302 | 非対応 (sync のみ) | 予測ノイジー (K サンプル平均で緩和)。40ep/30K では他 3 者に劣る |

- SmolVLA の位置づけ: **学習コスト最小 (GR00T の約 1/3、VLA-JEPA の約 1/12 の時間) で、
  実機のリアルタイム性 (RTC) を唯一問題なく満たした**。
