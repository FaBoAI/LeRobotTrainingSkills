...
## 5. 6 ポリシー比較 (本環境, 同一タスク 640×360。LingBot-VA のみ 58ep 版データセット・実機見送り)
...
|---|---|---|---|---|---|
| **SmolVLA** | batch8, 4.2 step/s | 20K ≈ 80 分 | 0.034 | **対応・良好** | **RTC で滑らか。6 ポリシー中の推奨** |
...
| LingBot-VA | batch4, 1.8 s/step (要パッチ) | 30K ≈ 15.3h | 0.24 (プラトー) | 非対応 (sync のみ) | オフライン関門不合格 (方向一致 0.66 で頭打ち) → 実機見送り |
